...
namespace RPGCreator.UI.Styles
{
    public abstract class BaseStyle
    {
        ...
        public abstract int TextFontSize { get; }
        public abstract int MediumTextFontSize { get; } // Default to TextFontSize, can be overridden if needed
        public abstract int SmallTextFontSize { get; }
    }
}
