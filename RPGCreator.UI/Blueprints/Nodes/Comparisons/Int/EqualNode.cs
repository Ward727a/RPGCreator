...
public class EqualNode : BaseNodeLogic
{
    public override FlowType FlowType => FlowType.Pure;
    public override string Title { get; } = "Equal";
    public override PipedPath Category { get; } = "Comparisons".ToPipedPath().Extend("Integer");
    public override URN Urn { get; } = DefaultUrnModule.ToUrnModule("rpgc").ToUrn("comparisons_int_equal_node");
