...
public class LessThanNode : BaseNodeLogic
{
    public override FlowType FlowType => FlowType.Pure;
    public override string Title { get; } = "Less Than";
    public override PipedPath Category { get; } = "Comparisons".ToPipedPath().Extend("Integer");
    public override URN Urn { get; } = DefaultUrnModule.ToUrnModule("rpgc").ToUrn("comparisons_int_less_than_node");
