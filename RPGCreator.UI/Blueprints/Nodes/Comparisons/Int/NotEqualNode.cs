...
public class NotEqualNode : BaseNodeLogic
{
    public override FlowType FlowType => FlowType.Pure;
    public override string Title { get; } = "Not Equal";
    public override PipedPath Category { get; } = "Comparisons".ToPipedPath().Extend("Integer");
    public override URN Urn { get; } = DefaultUrnModule.ToUrnModule("rpgc").ToUrn("comparisons_int_not_equal_node");
