...
public class EndNode : BaseNodeLogic
{
    public override FlowType FlowType => FlowType.Terminal;
    public override IReadOnlyList<IConnectorLogic> Inputs {get; set;} = [new ExecConnectorLogic("Finish")];
    ...
    public override URN Urn => DefaultUrnModule.ToUrnModule("rpgc").ToUrn("end_node");
    public override URN HelpUrn => IDocService.DocsUrnModule.ToUrnModule("rpgc").ToUrn("end_node");
