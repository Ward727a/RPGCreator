...
public class FloatToStringNode : BaseNodeLogic
{
    ...
    public override URN Urn { get; } = DefaultUrnModule.ToUrnModule("rpgc").ToUrn("float_to_string_node");
    ...
    public override IReadOnlyList<IConnectorLogic> Outputs { get; set; } = new List<IConnectorLogic> { new StringConnectorLogic("Converted value") };
    ...
    public override void GenerateCode(CodeContext context, IndentedTextWriter writer)
    {
        ...
        writer.WriteLine();
        writer.WriteLine("// FLOAT TO STRING");
        ...
        else
        {
            ...
            {
                Logger.Error("ERROR WHILE GENERATING CODE: FLOAT TO STRING NODE: NO VALUE FOUND IN INPUT");
                writer.WriteLine("// ERROR WHILE GENERATING CODE: FLOAT TO STRING NODE: NO VALUE FOUND IN INPUT");
                writer.WriteLine($"string {varName} = \"-1f\";");
                return;
            };
