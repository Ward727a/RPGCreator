...
using RPGCreator.UI.Views.Launcher;
using System;
...
namespace RPGCreator.UI.ViewModels.Launcher.Windows
{
    internal partial class ProjectCreatorViewModel : ViewModelBase
    {
        ...
        private void CreateProject()
        {
            ...
            {
                Error = $"Error: {RPGCreator.UI.Lang.Resources.Launcher_ProjectCreator_ErrorNoName}";
                return;
            }
