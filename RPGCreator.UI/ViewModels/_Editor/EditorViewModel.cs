...
namespace RPGCreator.UI.ViewModels._Editor
{
    public partial class EditorViewModel : ViewModelBase
    {
        ...
        public EditorViewModel()
        {
            ...
            // This is useless as we already awaiting for the project to be loaded in the LauncherViewModel before opening the editor.
            //EngineCore.Instance.Managers.Projects.Events.LoadedProject += (object? sender, ProjectsManagerLoadedProjectArgs args) =>
            //{
            //    if (args.LoadedProject != null)
            //    {
            //        EngineCore.Instance.Data.RTPGame._events.RTPLoadedContent += GameEditor_OnLoaded;
            //    }
            //};
        ...
        private void AddLayer()
        {
            ...
            EditorGame.CurrentMap?.AddLayer(NewLayerName);

            LayersName = EditorGame.CurrentMap?.Layers.Select(e => e.Name).ToList() ?? [];
        }
