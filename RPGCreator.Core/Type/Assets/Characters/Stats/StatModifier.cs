...
public class StatModifier : IStatModifier
{
    ...
    public void SetObjectData(DeserializationInfo info)
    {
        ...
        info.TryGetValue("Unique", out var unique, Ulid.Empty, "StatModifier.Unique not found, using default value Ulid.Empty.");
        Unique = unique;
        ...
        // Source = source;
        info.TryGetValue("Priority", out var priority, 0, "StatModifier.Priority not found, using default value 0.");
        Priority = priority;
        info.TryGetValue("Mode", out var mode, EStatModifierMode.Flat, "StatModifier.Mode not found, using default value EStatModifierMode.Flat.");
        Mode = mode;
        info.TryGetValue("Value", out var value, 0f, "StatModifier.Value not found, using default value 0f.");
        Value = value;
        info.TryGetValue("StatsUnique", out var statsUnique, Ulid.Empty, "StatModifier.StatsUnique not found, using default value Ulid.Empty.");
