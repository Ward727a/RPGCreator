...
public class AutoTilesetDef : ImageAsset, ITilesetDef
{
    ...
    public void SetObjectData(DeserializationInfo info)
    {
        ...
        info.TryGetValue("TileWidth", out int tileWidth, 32, "TileInstance width not found or invalid (Set to 32 by default).");
        info.TryGetValue("TileHeight", out int tileHeight, 32, "TileInstance height not found or invalid (Set to 32 by default).");
        info.TryGetList("AutotileGroups", out List<AutotileGroupDef> autotileGroups, new List<AutotileGroupDef>(), "Autotile groups not found or invalid (Set to empty list by default).");
