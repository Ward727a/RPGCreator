...
public class GraphSkillEffect : ISkillEffect, IHasSavePath, ISerializable, IDeserializable
{
    ...
    {
        info.TryGetValue(nameof(Unique), out Ulid unique, Ulid.NewUlid(), "Error while deserializing GraphSkillEffect.Unique");
        info.TryGetValue(nameof(DisplayName), out string displayName, string.Empty, "Error while deserializing GraphSkillEffect.DisplayName");
        info.TryGetList(nameof(PropertyDescriptors), out List<SkillEffectPropertyDescriptor> propertyDescriptors);
        info.TryGetValue(nameof(GraphEvent), out string graphEventPath, string.Empty, "Error while deserializing GraphSkillEffect.GraphEvent");
