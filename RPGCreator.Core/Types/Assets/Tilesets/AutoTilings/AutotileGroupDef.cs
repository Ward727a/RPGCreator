...
public class AutotileGroupDef : IHasUniqueId, ISerializable, IDeserializable
{
    ...
    public void SetObjectData(DeserializationInfo info)
    {
        ...
        info.TryGetValue(nameof(BaseTile), out ITileDef? baseTile, null);
        info.TryGetList(nameof(_tiles), out List<AutotileDef> tiles);
        info.TryGetList(nameof(_tags), out List<string> tags);
