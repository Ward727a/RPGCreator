...
{
    public class AssetsManagerUpdatingAssetArgs : BasePreEventArgs
    {

        BaseAsset.TYPE Type = BaseAsset.TYPE.UNKNOWN;

        public AssetsManagerUpdatingAssetArgs(BaseAsset.TYPE type)
        {
            Type = type;
        }
