...
{
    public class AssetsManagerAddedAssetArgs : BasePostEventArgs<AssetsManagerAddedAssetArgs>
    {
        ...
        public AssetsManagerAddedAssetArgs(string packName, BaseAsset asset, bool success)
        {
            PackName = packName;
            Asset = asset;
            Success = success;
