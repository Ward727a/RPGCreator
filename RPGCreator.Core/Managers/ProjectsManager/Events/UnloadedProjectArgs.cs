...
{
    public class ProjectsManagerUnloadedProjectArgs : BasePostEventArgs<ProjectsManagerUnloadedProjectArgs>
    {

        public readonly BaseProject? Project;

        public ProjectsManagerUnloadedProjectArgs(BaseProject? project)
        {
            Project = project;
        }
