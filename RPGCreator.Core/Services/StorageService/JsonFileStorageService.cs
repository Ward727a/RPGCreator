...
namespace RPGCreator.Core.Services.StorageService;

public class JsonFileStorageService : IFileStorageService
{
    
    public static JsonFileStorageService Shared { get; } = new();
    ...
    public Result<T> InternalLoad<T>(object path)
    {
        ...
        EngineServices.Serializer.DeserializeFrom<T>(pathStr, out var obj);
    ...
    public Result InternalSave<T>(object path, T data)
    {
        ...
        EngineServices.Serializer.SerializeTo(data, pathStr);
