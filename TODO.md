...
* [ ]  Cleaning legacy code in old assets (like animationDef, CharacterData, etc...)
* [ ]  Switch from NewtonsoftJson to System.Text.Json for better performance and maintainability
