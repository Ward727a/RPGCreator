...
namespace RPGCreator.EngineLib.Module;


public class FeatureManager : IFeaturesManager
{
    private static readonly ScopedLogger Logger = SDK.Common.Logging.Logger.ForContext<FeatureManager>();
    ...
    {
        RegisterEntityFeature<SpriteFeature>();
        RegisterEntityFeature<BoundsFeature>();
    }
